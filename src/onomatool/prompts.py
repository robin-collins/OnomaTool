...
DEFAULT_USER_PROMPT = (
    ...
    "where, why, and how of the file content, its purpose or intended use. A good file name should "
    ...
    "or file trees. Avoid assumptions unless other indicators are ambiguous or not present. "
    ...
    "the content. When including numbers (dates, times, IDs), keep digit sequences reasonable - "
